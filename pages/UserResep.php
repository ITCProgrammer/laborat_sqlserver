        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <a href="#" data-toggle="modal" data-target="#DataUserResep" class="btn btn-success"><i class="fa fa-plus-circle"></i> Add</a>
                </div>
                <div class="box-body">
                                            ...
                                            <form class="form-horizontal" name="modal_popup" data-toggle="validator" method="post" action="?p=POSTedit_userresep">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $rowd['nama'] ?>" readonly required>
                    ...
                    <div class="modal fade modal-super-scaled" id="DataUserResep">
                        <div class="modal-dialog ">
                            <div class="modal-content">
                                <form class="form-horizontal" name="modal_popup" data-toggle="validator" method="post" action="?p=simpan_userresep">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span></button>
                                        <h4 class="modal-title">Add Data User Resep</h4>
                                    </div>
                                    <div class="modal-body">
                    ...
                    <div id="UserResepEdit" class="modal fade modal-3d-slit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<script>
    $(document).ready(function() {
        $("#DataUserResep").on('shown.bs.modal', function() {
            $('#nama').focus();
        })
    })
</script>
