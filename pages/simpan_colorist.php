...
if ($_POST) {
    ...
    $insertSql = "INSERT INTO db_laborat.tbl_colorist (nama, is_active, created_at, created_by)
                  VALUES (?, ?, ?, ?)";
    ...
    $logSql = "INSERT INTO db_laborat.tbl_log (what, what_do, do_by, do_at, ip, os, remark)
               VALUES (?, ?, ?, ?, ?, ?, ?)";
    $logParams = [$nama, 'INSERT INTO tbl_colorist', $userLAB, $date, $ip, $os, "Insert new colorist $nama"];
