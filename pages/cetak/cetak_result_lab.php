      ...
      <tr>
        <td align="left" valign="top" bgcolor="#ECE8E8">Note:
          ...
          if ($rcek1['ss_cmt'] == '1') {
            ...
            $apperssNote = $rcek1['apperss_note'] ?? '';
            $noteG = $rcek1['note_g'] ?? '';
            echo str_replace($apperssNote, "", $noteG);
          }
          ?>
        </td>
      </tr>
