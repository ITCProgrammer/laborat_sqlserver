...
<body>
    ...
    <table border="1">
        ...
        while ($row = db2_fetch_assoc($Balance_stock)) {
            ...
            //                                 b.DECOSUBCODE03,
            //                                 CASE 
            //                                     WHEN b.BASEPRIMARYUNITCODE = 'kg' THEN round(sum(b.BASEPRIMARYQUANTITYUNIT)*1000)
            //                                     WHEN b.BASEPRIMARYUNITCODE = 't' THEN round(sum(b.BASEPRIMARYQUANTITYUNIT)*1000000)
            //                                     ELSE round(sum(b.BASEPRIMARYQUANTITYUNIT))
            ...
            $pakai_belum_timbang = db2_exec($conn1, "SELECT 
                                                                                ...
                                                                                DECOSUBCODE03,
                                                                               STATUS,
                                                                                round(sum(BASEPRIMARYQUANTITY)) AS USERPRIMARYQUANTITY,
                                                                                BASEPRIMARYUNITCODE
                                                                            FROM 
                                                                                (
                                                                                SELECT 
            ...
            if ($tahunBulan2 == '2025-08') {
                ...
                $params = [$kode_obat, $kode_obat, $awal];
                $q_qty_awal = sqlsrv_query($con, $sql_qty_awal, $params);
            }
            ...
            $params = [$kode_obat, $kode_obat, $akhir];
            ...
            echo "<tr>
                ...
                <td class='number'>" . number_format($qty_Balance_pisah, 0, '.', ',') . "</td>
