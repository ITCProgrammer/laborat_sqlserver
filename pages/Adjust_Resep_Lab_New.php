...
$sql = sqlsrv_query(
    $con,
    "SELECT TOP (1) a.id as id_status, a.idm, b.id AS id_tblmatching, a.flag, a.grp, a.matcher, a.cek_warna, a.cek_dye, a.status, a.kt_status, 
...
b.proses, b.buyer, a.final_matcher, a.colorist1, a.colorist2,a.colorist3, a.colorist4,a.colorist5, a.colorist6,a.colorist7, a.colorist8, a.bleaching_tm, a.bleaching_sh, a.second_lr, a.howmany_percobaan_ke,
                    ...
                    <div class="col-lg-12 overflow-auto table-responsive well" style="overflow-x: auto;">
                        <table id="lookupmodal1" class="lookupST display nowrap" width="120%" style="padding-right: 16px;">
                            ...
                            $hold_resep = sqlsrv_query(
                                $con,
                                "SELECT * FROM db_laborat.tbl_matching_detail WHERE id_matching = ? AND id_status = ? AND NOT resep = 'dye' ORDER BY flag",
...
<script>
    $(document).ready(function() {
        ...
        $('#plus1').click(function () {
            let lastRow = $('#tb-lookup1 tr:last');
            let getno = lastRow.find('td:first').html();
            ...
            // clone baris terakhir supaya struktur tetap sama tapi tidak bawa nilainya
            ...
            // set nomor urut
            newRow.find('td:first').html(nomor);

            // ganti kolom ke-2 dengan select baru seperti sebelumnya
            newRow.find('td:eq(1)').html(
                '<select style="width: 100%" type="text" class="form-control input-xs code" placeholder="type code here .."></select>'
            );

            // pastikan semua input bisa diedit
            newRow.find('input.form-control.input-xs.conc').prop('readonly', false);
            newRow.find('td:last input').prop('readonly', false);

            // tambahkan baris baru ke tabel
            $('#tb-lookup1').append(newRow);
        });
