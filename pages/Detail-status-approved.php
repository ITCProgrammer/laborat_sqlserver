                        ...
                        *Detail Data yang akan di export :<br>
                        <table class="lookupST display nowrap" width="100%" style="padding-right: 16px;">
                            <tr>
                                ...
                                <td colspan="2">
                                    ...
                                    <?php // if ($_SESSION['userLAB'] == 'Cliviaugina' OR $_SESSION['userLAB'] == 'cliviaugina') : ?>
                                        <!-- <br>
                                        <br> -->
                                        <a class="bbtn btn-sm btn-warning approve btn-export-recipe-csv3" data-rcode="<?= $data['recipe_code_2']; ?>" href="ExportRecipeCSV3.php?idm=<?= $_GET['idm']; ?>&id=<?= $data['id']; ?>&suffix=1&IMPORTAUTOCOUNTER=<?= $dataD['id']; ?>&rcode=<?= $data['recipe_code_1']; ?>&numbersuffix=<?= $data['idm']; ?>&userLogin=<?= $_SESSION['userLAB']; ?>">
                            ...
                            <tr>
                                ...
                                <td colspan="3">: <?= $data['recipe_code_2']; ?></td>
                            </tr>
                            <tr>
                                ...
                                $q_frist_add = sqlsrv_query($con, "SELECT 
                                                                        ...
                                                                        CASE
                                                                            ...
                                                                            WHEN LEFT(tsm.idm, 2) = 'A2' THEN 
                                                                                CASE
                                                                                    WHEN MAX(tsm.tside_c) = 0 AND MAX(tsm.tside_min) = 0
                                                                                        THEN CONCAT(TRIM(MAX(tsm.cside_c)),'`C X ', TRIM(MAX(tsm.cside_min)), ' MNT')
                                                                    ...
                                                                    SELECT
                                                                        ...
                                                                        END as no_resep_convert,
                                                                        CASE
                                                                            WHEN TRIM(MAX(tsm.soaping_sh)) = '80'
                                                                                THEN CONCAT('CUCI PANAS ', TRIM(MAX(tsm.soaping_sh)),'`C X ', TRIM(MAX(tsm.soaping_tm)), ' MNT')
                                                                    ...
                                                                    LEFT JOIN db_laborat.tbl_matching_detail a ON a.id_matching = b.id
                                                                    WHERE tsm.idm = '$data[idm]'
                                                                    AND (LEFT(tsm.idm, 2) = 'R2' OR LEFT(tsm.idm, 2) = 'A2')
                                                                    AND (NOT LEFT(tsm.idm, 2) = 'D2' OR NOT LEFT(tsm.idm, 2) = 'DR')
                                                                    GROUP BY b.no_resep
                                                                    UNION
                                                                    SELECT
                                                                        MAX(b.recipe_code) as recipe_code,
                                                                    ...
                                                                    LEFT JOIN db_laborat.tbl_matching_detail a ON a.id_matching = b.id
                                                                    WHERE tsm.idm = '$data[idm]'
                                                                    AND (LEFT(tsm.idm, 2) = 'CD' OR LEFT(tsm.idm, 2) = 'D2' OR LEFT(tsm.idm, 2) = 'DR' OR LEFT(tsm.idm, 2) = 'A2')
                                                                    AND NOT tsm.rc_sh = 0
                                                                    GROUP BY b.no_resep
                                                                    UNION
                                                                    SELECT
                                                                    ...
                                                                    LEFT JOIN db_laborat.tbl_matching_detail a ON a.id_matching = b.id
                                                                    WHERE tsm.idm = '$data[idm]'
                                                                    AND (LEFT(tsm.idm, 2) = 'CD' OR LEFT(tsm.idm, 2) = 'D2' OR LEFT(tsm.idm, 2) = 'DR')
                                                                    AND NOT tsm.bleaching_sh = 0
                                                                    GROUP BY b.no_resep");
                                if (!$q_frist_add) {
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            *Detail Data yang akan di export :
                            <!-- frist -->
                            <table class="lookupST display nowrap">
                                <tr>
                            ...
                            <table class="lookupST display nowrap">
                                ...
                                <?php 
                                if(!$q_frist){
                                    echo "<tr><td colspan='5'>Query gagal: ".htmlentities(print_r(sqlsrv_errors(),true))."</td></tr>";
                                }
                                while ($q_frist && $d_frist = sqlsrv_fetch_array($q_frist, SQLSRV_FETCH_ASSOC)) { ?>
                                        <tr>
                                            <td><?= $d_frist['flag']; ?></td>
                                            <td><?= $d_frist['kode']; ?></td>
                                            <td><?= $d_frist['nama']; ?></td>
                                    ...
                                    $q_frist_add = sqlsrv_query($con, "SELECT 
                                                                        ...
                                                                        SELECT
                                                                            ...
                                                                            CASE
                                                                                ...
                                                                                WHEN SUBSTRING(MAX(b.no_resep), 1,2) = 'D2' OR SUBSTRING(MAX(b.no_resep), 1,2) = 'R2' OR SUBSTRING(MAX(b.no_resep), 1,2) = 'A2'
                                                                                    THEN CONCAT(SUBSTRING(MAX(b.no_resep), 2, LEN(MAX(b.no_resep))), 'L')
                                                                            END as no_resep_convert,
                                                                            CONCAT('SOAPING ', TRIM(MAX(tsm.soaping_sh)), '''C X ', TRIM(MAX(tsm.soaping_tm)), ' MNT') as COMMENTLINE
                                                                        FROM db_laborat.tbl_status_matching tsm 
                                                                        LEFT JOIN db_laborat.tbl_matching b ON b.no_resep = tsm.idm
                                                                        LEFT JOIN db_laborat.tbl_matching_detail a ON a.id_matching = b.id
                                                                        WHERE tsm.idm = '$data[idm]' 
                                                                        AND (LEFT(tsm.idm, 2) = 'R2' OR NOT LEFT(tsm.idm, 3) = 'DR2')
                                                                        GROUP BY b.no_resep
                                                                        UNION
                                                                        SELECT
                                                                            MAX(b.recipe_code) as recipe_code,
                                                                        ...
                                                                        LEFT JOIN db_laborat.tbl_matching_detail a ON a.id_matching = b.id
                                                                        WHERE tsm.idm = '$data[idm]' 
                                                                        AND (LEFT(tsm.idm, 2) = 'CD' OR LEFT(tsm.idm, 3) = 'D2' OR LEFT(tsm.idm, 2) = 'DR')
                                                                        AND NOT tsm.rc_sh = 0
                                                                        GROUP BY b.no_resep
                                                                        UNION
                                                                        SELECT
                                                                        ...
                                                                        GROUP BY b.no_resep");
                                    if(!$q_frist_add){
                                        echo "<tr><td colspan='5'>Query add gagal 2: ".htmlentities(print_r(sqlsrv_errors(),true))."</td></tr>";
                                    }
                                    ?>
                                    <?php while ($q_frist_add && $d_frist_add = sqlsrv_fetch_array($q_frist_add, SQLSRV_FETCH_ASSOC)) { ?>
                                        <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php // if ($_SESSION['userLAB'] == 'Cliviaugina' OR $_SESSION['userLAB'] == 'cliviaugina') : ?>
                                            <!-- <br>
                                            <br> -->
                                            <a class="bbtn btn-sm btn-warning approve btn-export-recipe-csv3" data-rcode="<?= $data['recipe_code_2']; ?>" href="ExportRecipeCSV3.php?idm=<?= $_GET['idm']; ?>&id=<?= $data['id']; ?>&suffix=2&IMPORTAUTOCOUNTER=<?= $dataR['id']; ?>&rcode=<?= $data['recipe_code_2']; ?>&numbersuffix=<?= $data['idm']; ?>&userLogin=<?= $_SESSION['userLAB']; ?>">
                                                <i class="fa fa-cloud-upload" aria-hidden="true"></i> Export Recipe <?= $data['recipe_code_2']; ?>
                                            </a>
                                            <!-- <br>
                                            <br>
                                    ...
                                    $q_frist_add = sqlsrv_query($con, "SELECT 
                                                                            ...
                                                                            CASE
                                                                                ...
                                                                                WHEN SUBSTRING(MAX(b.no_resep), 1,2) = 'D2' OR SUBSTRING(MAX(b.no_resep), 1,2) = 'R2' OR SUBSTRING(MAX(b.no_resep), 1,2) = 'A2'
                                                                                    THEN CONCAT(SUBSTRING(MAX(b.no_resep), 2, LEN(MAX(b.no_resep))), 'L')
                                                                            END as no_resep_convert,
                                                                            CONCAT(TRIM(MAX(tsm.cside_c)),'`C X ', TRIM(MAX(tsm.cside_min)), ' MNT') as COMMENTLINE
                                                                        FROM db_laborat.tbl_status_matching tsm 
                                                                        LEFT JOIN db_laborat.tbl_matching b ON b.no_resep = tsm.idm
                                                                        LEFT JOIN db_laborat.tbl_matching_detail a ON a.id_matching = b.id
                                                                        WHERE tsm.idm = '$data[idm]'
                                                                        ...
                                                                        LEFT JOIN db_laborat.tbl_matching_detail a ON a.id_matching = b.id
                                                                        WHERE tsm.idm = '$data[idm]' 
                                                                        AND (LEFT(tsm.idm, 2) = 'R2' OR LEFT(tsm.idm, 3) = 'DR2')
                                                                        GROUP BY b.no_resep
                                                                        UNION
                                                                        SELECT
                                                                            MAX(b.recipe_code) as recipe_code,
                                                                        ...
                                                                        LEFT JOIN db_laborat.tbl_matching_detail a ON a.id_matching = b.id
                                                                        WHERE tsm.idm = '$data[idm]' 
                                                                        AND NOT (LEFT(tsm.idm, 2) = 'CD' OR LEFT(tsm.idm, 3) = 'D2' OR LEFT(tsm.idm, 2) = 'DR')
                                                                        AND NOT tsm.rc_tm = 0
                                                                        GROUP BY b.no_resep
                                                                        UNION
                                                                        SELECT
                                                                        ...
                                                                        GROUP BY b.no_resep");
                                    if(!$q_frist_add){
                                        echo "<tr><td colspan='5'>Query add gagal 3: ".htmlentities(print_r(sqlsrv_errors(),true))."</td></tr>";
                                    }
                                    ?>
                                    <?php while ($q_frist_add && $d_frist_add = sqlsrv_fetch_array($q_frist_add, SQLSRV_FETCH_ASSOC)) { ?>
                                        <tr>
